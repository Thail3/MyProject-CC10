...
function ProfileHeader() {
  ...
  const handleChangeBackground = async (e) => {
    try {
      ...
      await axios.patch("/users/background-img", formData);
  ...
  const handleSubmitAbout = async (e) => {
    try {
      ...
      const res = await axios.patch(`/users/${user.id}`, { about: editAbout });
                ...
                <img
                  src={
                    backgroundUpdate
                      ...
                      : user.backgroundImg ?? backgroundUpdate
                  }
                  className=""
                  alt="user"
                  role="button"
